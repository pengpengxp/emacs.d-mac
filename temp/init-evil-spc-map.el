...
(define-key peng-evil-normal-map (kbd "x") ctl-x-map)
...
;; (define-key evil-normal-state-map (kbd "SPC x") 'peng-evil-normal-map)
;; (define-key evil-normal-state-map (kbd "SPC xr") 'peng-evil-normal-map)
;; (define-key evil-normal-state-map (kbd "SPC c") 'peng-evil-normal-map)
