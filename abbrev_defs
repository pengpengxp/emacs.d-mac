...
(define-abbrev-table 'weibo-image-mode-abbrev-table '())

(define-abbrev-table 'weibo-post-mode-abbrev-table '())

(define-abbrev-table 'weibo-timeline-mode-abbrev-table '())

(define-abbrev-table 'weibo-user-mode-abbrev-table '())
